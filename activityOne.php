...
$_SESSION["eurCountryOrder"] = $_POST["countryList"];
...
$actPlaceList = $p1."\r\n".$p2."\r\n".$p3."\r\n".$p4."\r\n".$p5;
$_SESSION["eur_sel_place"] = $actPlaceList;
...
?>
    ...
    <!--   Establish establish form -->
     <form id= "surveyForm"  action="surveyOneV2_2.php"  method="post">
        
      <p class = "question"><label for="totalTravelers">2. What is the amount of people going on this trip? (Including yourself): 
      <input type="number" id="totalTravelers" value = 1 name="totalTravelers" required min="1" max="5"></label></p>
        <br><br>
       
        <input type="hidden" id="countryList" name="countryList"><br><br>
       
        
      <p class ="question">3. What are the activities you would consider doing, taking your budget into consideration?</p><br><br>
    ...
    <a href='surveyOneV2_1.php'><button>Previous Question</button></a>
          <input type = "button" name="button2"  value="Next Question" onclick ="Submit()"><br>
      </div>
